        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoundedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternateTitles = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CommunityRating = table.Column<double>(type: "float", nullable: true),
                    CriticRating = table.Column<double>(type: "float", nullable: true),
                    ReleaseDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    OriginalReleaseDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    EarlyAccessDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    FanArt = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PegiRating = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MetacriticScore = table.Column<int>(type: "int", nullable: true),
                    OpenCriticScore = table.Column<int>(type: "int", nullable: true),
                    MultiplayerSupport = table.Column<bool>(type: "bit", nullable: false),
                    CoopSupport = table.Column<bool>(type: "bit", nullable: false),
                    VrSupport = table.Column<bool>(type: "bit", nullable: false),
                    CrossplaySupport = table.Column<bool>(type: "bit", nullable: false),
                    CloudSaveSupport = table.Column<bool>(type: "bit", nullable: false),
                    ControllerSupport = table.Column<bool>(type: "bit", nullable: false),
                    SteamDeckCompatibility = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AchievementCount = table.Column<int>(type: "int", nullable: false),
                    DlcCount = table.Column<int>(type: "int", nullable: false),
                    ExpansionCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameDevelopers", x => new { x.DevelopersId, x.GamesId });
                    table.ForeignKey(
                        name: "FK_GameDevelopers_Developers_DevelopersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePublishers", x => new { x.GamesId, x.PublishersId });
                    table.ForeignKey(
                        name: "FK_GamePublishers_Games_GamesId",
                        column: x => x.GamesId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamePublishers_Publishers_PublishersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameServices", x => new { x.DigitalServicesId, x.GamesId });
                    table.ForeignKey(
                        name: "FK_GameServices_DigitalServices_DigitalServicesId",
                        column: x => x.DigitalServicesId,
                        principalTable: "DigitalServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameServices_Games_GamesId",
                        column: x => x.GamesId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameThemes", x => new { x.GamesId, x.ThemesId });
                    table.ForeignKey(
                        name: "FK_GameThemes_Games_GamesId",
                        column: x => x.GamesId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameThemes_Themes_ThemesId",
                        column: x => x.ThemesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameDevelopers_GamesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePublishers_PublishersId",
